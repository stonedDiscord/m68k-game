...
void  ct_set_timer(uint16_t preload);   /* Load preload, configure as timer   */
void  ct_start(void);                   /* Issue start-counter command (read)  */
void  ct_stop(void);                    /* Issue stop-counter command (read)   */
uint16_t ct_read(void);                 /* Read current count (counter stopped)*/
